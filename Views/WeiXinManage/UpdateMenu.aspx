...
<asp:Content ID="Content2" ContentPlaceHolderID="LinkContent" runat="server">
    ...
    <script src="../../Scripts/Menu/UpdateMenuJs.js" type="text/javascript"></script>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="mod-title t10">
        <div class="con style0h1-02">
            <a class="a-btn float-l" onclick="GoToLinkUrl(event)" title="返回" href="#"><i linkurl="WeiXinMenuList"
                class="icon-back"></i></a>
            <h1 class="spanTitle">
                修改菜单</h1>
        </div>
                                ...
                                <div class="form-touch t10" id="plus">
                                    ...
                                    <div class="t2">
                                        <input type="radio" value="view" id="Radio2" name="after1"><label for="Radio2" class="l5 r5">进入链接</label><input
                                            type="text" id="txtMenuUrl2" value="请输入url" class="w210"></div>
                                </div>
                            </li>
                        </ul>
                    </div>
