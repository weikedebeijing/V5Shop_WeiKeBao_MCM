...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <%if (ViewData["productInDrpInfo"] != null)
      { %>
    <div>
        <% V5.MetaData.Customer.Model.ProductInDrpInfo productInDrpInfo = (V5.MetaData.Customer.Model.ProductInDrpInfo)ViewData["productInDrpInfo"];%>
        <div class="MCM-C-M ">
            <div class="con style01">
                <div class="mod-tab-con">
                    ...
                    <ul class="btn">
                        <li><a id="goBack" href="" title="返回" class="returnBtn">返回</a> 分销规格清单 </li>
                    </ul>
                </div>
                <div id="separationLine" class="separationLine">
                </div>
                <div>
                    <%=productInDrpInfo.ProductName%></div>
                    ...
                    <div class="con style01" id="GetGradeViewFlag">
                        <table cellspacing="0" cellpadding="0" border="0" style="min-width: 740px;">
                            ...
                            <tbody>
                                <tr>
                                    <td>
                                        <%=productInDrpInfo.OuterCode%>
                                        <span id="NumIid" ><%=productInDrpInfo.NumIid%></span>
                                    </td>
                                    <td>
                                        <a style="color: #0066cc;" href="http://shop<%=productInDrpInfo.ShopID %>.taobao.com"
                                            target="_blank">
                                            <%=productInDrpInfo.ShopName%></a>
                                    </td>
                                    <td>
                                        <%=productInDrpInfo.SkuCount%>
                                    </td>
                                    <td>
                                        <%=productInDrpInfo.CategoryName%>
                                    </td>
                                    <td>
                                        <%=productInDrpInfo.ProductLineName%>
                                    </td>
                                    <td>
                                    </td>
                                </tr>
            ...
            <div style="clear: both;">
                ...
                <div id="flexigridDiv">
                    <% 
                        Html.RenderAction("GetProductInDrpChannelList", new { CurrentPageIndex = 0, CustomerID = "", ProductID = "", NumIid="" });//首次加载，实际上不需要出现数据，数据有ajax请求呈现，这里将currentIndex置为0
                    %>
                </div>
                <!--放表格的容器-->
            </div>
    ...
    <script type="text/javascript">
        ...
        function GetPrice(obj, OuterNo, SessionKey) {
            ...
            $.ajax({
                ...
                data: { "OuterNo": OuterNo, "SessionKey": SessionKey, "NumIid": NumIid },
