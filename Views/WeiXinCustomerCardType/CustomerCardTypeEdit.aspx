...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="mod-form t20">
        <div class="con style0page">
            <%var customerCardType = (V5.MetaData.WeiXin.Model.CustomerCardType)ViewData["customerCardType"]; %>
            <!---name begin--->
            <h2 class="title-h2">
            ...
            <ul class="list-ul l26">
                <li class="list-li">
                    ...
                    <div class="float-l">
                        <input type="text" id="CustomerCardName" class="w230" name="name" value='<%:customerCardType.CardName %>' /></div>
                    <div class="float-l">
                ...
                <li class="list-li">
                    ...
                    <div class="float-l">
                        <input type="text" class="w150" name="name" value='<%:customerCardType.CardFrontNumer %>'
                            id="CardFrontNumer" placeholder="如有前缀请输入" />
                        <input type="text" class="w150" name="name" value='<%:customerCardType.CardStartNumber %>'
                            id="CardStartNumber" placeholder="请输入起始卡号" />
                    </div>
                    <div class="float-l">
                        <span class="prompt"></span>
                    </div>
                ...
                <li class="list-li">
                    ...
                    <div class="float-l">
                        <input type="text" id="CreateNum" class="w230" name="name" value='<%:customerCardType.CreateNum %>'></div>
                    <div class="float-l">
                        <span class="prompt"></span>
                    </div>
                </li>
                <li class="list-li">
                    <div class="float-l w130">
                        ...
                        <label>
                            剔除卡号末位数字</label></div>
                    <div class="float-l">
                        <input type="text" id="RemoveEndNumber" class="w230" name="name" value='<%:customerCardType.RemoveEndNumber %>' /><span>用"|"分割</span></div>
                    <div class="float-l">
                        <span class="prompt"></span>
                    </div>
                </li>
                    ...
                    <div class="float-l">
                        ...
                        <div class="file01">
                            <span class="pic-place w300 h150">
                                <img width="300px" height="150px" src='<%:customerCardType.CardImgUrl %>' alt='' id='choseImg' />
                            </span>
                            <div class="btn">
    ...
    <script type="text/javascript">
        ...
        var saveAll = function () {
            ...
            for (var i = 0; i < trs.length; i++) {
                ...
                var textInputValue = $(trs[i]).find("div[dir=textInputValue]").text().trim();
            ...
            $.ajax({
                url: "/WeiXinCustomerCardType/CustomerCardTypeEdit",
                data: sendDatas,
                type: "post",
