            ...
            <div class="con style0page">
                <ul class="list-ul">
                    ...
                    <li class="list-li">
                        ...
                        <div class="float-l">
                            <input type="text" id="Account" name="Account" class="w230" />
                    ...
                    <li class="list-li">
                        ...
                        <div class="float-l">
                            <input type="text" id="PID" name="PID" class="w230" /><span class="spMessage"></span>
                        </div>
                    </li>
                    <li class="list-li">
                        <div class="float-l w130">
                        ...
                        <div class="float-l">
                            <input type="text" id="Key" name="Key" class="w230" /><span class="spMessage"></span>
                        </div>
                    </li>
                </ul>
    ...
    <script type="text/javascript">
        ...
        function afterOnSuccess() {
            if ($("#UpdateTargetHiddenID").html() == "ok") {
                ...
                $("#operateTip").html("添加成功! 点击跳转到<a href='/DRPSetting/PaymentList'>支付方式列表</a> ").change();
                //                  // 把添加成功放到<span>中
